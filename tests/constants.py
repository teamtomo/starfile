...
single_line_end_of_multiblock = (
    test_data_directory / "single_line_end_of_multiblock.star"
)
single_line_middle_of_multiblock = (
    test_data_directory / "single_line_middle_of_multiblock.star"
)
...
cars = {
    "Brand": ["Honda_Civic", "Toyota_Corolla", "Ford_Focus", "Audi_A4"],
    "Price": [22000, 25000, 27000, 35000],
}
test_df = pd.DataFrame.from_dict(cars)
test_df_pl = pl.DataFrame(cars)
